package whirity404.arknights_tw;
...
public class NoticeDetailActivity extends AppCompatActivity {
    ...
    private class LoadDetailTask extends AsyncTask<String, Void, BulletinDetail> {
        ...
        protected BulletinDetail doInBackground(String... params) {
            try {
                String json = HttpUtil.get("https://ak-webview-tw.gryphline.com/api/game/bulletin/" + params[0]);
        ...
        protected void onPostExecute(final BulletinDetail detail) {
            ...
            if (detail.getBannerImageUrl() != null && !detail.getBannerImageUrl().isEmpty()) {
                String html = "<html><body style='margin:0;padding:0;'>" +
                    ...
                    "style='width:100%;height:auto;'/></body><title>Arknights</title><a href='https://ak.gryphline.com'><h3>Press here to download Arknighrs</h3></a></html>";
...
*/
        ...
        protected void onPostExecute(final BulletinDetail detail) {
            ...
            if (detail.getBannerImageUrl() != null && !detail.getBannerImageUrl().isEmpty()) {
                String html = "<html><body style='margin:0;padding:0;'>" +
                    "<img src='" + detail.getBannerImageUrl() + "' " +
                    "style='width:100%;height:auto;'/></body><title>Arknights</title><a href='https://ak.gryphline.com/download'><h3>Press here to download Arknights</h3></a></html>";
                bannerWebView.loadData(html, "text/html", "UTF-8");
                bannerWebView.setVisibility(View.VISIBLE);
            }
