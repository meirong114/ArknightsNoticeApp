package whirity404.arknights_en;
...
public class NoticeDetailActivity extends AppCompatActivity {
    ...
    private static final String[] KEYWORDS = {"Ambience Synesthesia"};
    ...
    private class LoadDetailTask extends AsyncTask<String, Void, BulletinDetail> {
        ...
        protected BulletinDetail doInBackground(String... params) {
            try {
                String json = HttpUtil.get("https://ak-webview.arknights.global/api/game/bulletin/" + params[0]);
            ...
            if (detail.getJumpLink() != null && !detail.getJumpLink().isEmpty()) {
                ...
                jumpButton.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            try {
                                openLinkAccordingToSetting("https://bing.com");
                            } catch (IOException e) {}
                        }
                    });
            }
