...
import whirity404.arknights_en.NoticeDetailActivity;
...
public class BulletinListActivity extends AppCompatActivity {
    ...
    private class LoadBulletinTask extends AsyncTask<Void, Void, List<BulletinItem>> {
        ...
        protected List<BulletinItem> doInBackground(Void... voids) {
            try {
                String json = HttpUtil.get("https://ak-webview.arknights.jp/api/game/bulletinList?target=Android");
            ...
            if (result != null) {
                ...
                listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                        ...
                        Intent intent = new Intent(BulletinListActivity.this, NoticeDetailActivity2.class);
