...
public class NoticeDetailActivity2 extends AppCompatActivity {
    ...
    private class LoadDetailTask extends AsyncTask<String, Void, BulletinDetail> {
        ...
        private void openWithInternalBrowser(String url) {
            try {
                ...
                Intent intent = new Intent(NoticeDetailActivity2.this, NoticeWebActivity.class);
        ...
        private void openWithSystemBrowser(String url) {
            try {
                ...
                Toast.makeText(NoticeDetailActivity2.this, R.string.notopen_1, Toast.LENGTH_SHORT).show();
            }
        }
        ...
        protected void onPostExecute(final BulletinDetail detail) {
            ...
            if (detail == null) {
                Toast.makeText(NoticeDetailActivity2.this, 
        ...
        private void checkKeywords(String title) {
        }
    }
}
